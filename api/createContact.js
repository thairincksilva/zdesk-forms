...
const refreshToken = '1000.bc146e85c7feab9c9677b9ad571b9400.00b62f491d43d12ad1d12bbaa77d5700'; 
...
export default async function createContact(req, res) {
  ...
  const { firstName, lastName, email, accountName } = req.body; 

  console.log('Dados recebidos:', { firstName, lastName, email, accountName });
